    ...
    try {
      ...
      if (reportRef.current) {
        ...
        await html2pdf()
          .set({
            margin: [12, 12, 12, 12],
            filename: `Muni-Pal_Sensing_Report_${sectorName}_${new Date().toISOString().slice(0, 10)}.pdf`,
      ...
      <div className="mb-8 flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Download your complete sensing analysis as a PDF
          </p>
        </div>
      </div>
      ...
      {!hasData ? (
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8 text-center">
          ...
          <p className="text-sm text-gray-500 mb-6 max-w-md mx-auto">
            Use the sensing tools to generate results first, then return here to
            export your combined report as a PDF.
          </p>
        ...
        <>
          ...
          {!showForm && !leadCaptured && (
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 text-center mb-6">
              ...
              <p className="text-sm text-gray-500 mb-4">
                Enter your information to receive the combined PDF report.
              </p>
              <button
          ...
          >
            ...
            >
              This report was generated by Muni-Pal Sensing Tools using data
              from our corpus of public municipal securities disclosures. For professional
              advisory services, contact us at info@muni-pal.io.
            </div>
          </div>
        </>
      )}
