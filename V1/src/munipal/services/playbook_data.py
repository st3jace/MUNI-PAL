...
UCS_PLAYBOOK_CONFIG = {
    ...
    "version": "0.2.0",
    "description": "Bond Intelligence Configuration Playbook for UCS Waste-to-Energy Capital Appreciation + Sustainability-Linked Bond structures. Defines extraction schema, checklist phases P1-P6, and readiness scoring for El Dorado, California IDA-style revenue bond facilities.",
