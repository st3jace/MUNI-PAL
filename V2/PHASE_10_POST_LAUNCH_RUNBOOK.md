...
- `reports/phase10_postlaunch/ops1005_incident_drill_assessment_<timestamp>.md`
- `reports/phase10_postlaunch/ops1005_incident_drill_assessment_<timestamp>.json`
...
- OPS-1005 incident drill assessment reports status `no-go`
